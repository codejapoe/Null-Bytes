        ...
        try:
            ...
            try:
                ...
                if id in databases:    
                    ...
                    return render_template('data.html', username = username, password = password, id = id, data = data)
                
                else:
                    return render_template('error.html', code = 404, message = "Database Not Found", dir = "/database")
